"""
ZRJ70 — 76-seat high-wing regional jet sizing data.
...
AIRCRAFT = {
    ...
    # --- Mission ---
    "design_range_nm": 1800,            # nm, max design range
    "alternate_range_nm": 100,          # nm, alternate airport distance (Embraer-based)

    # --- Payload & Crew ---
    "payload_weight": 18_055,           # lbs, passengers + cargo (CRJ700 max payload)
    "n_pilots": 2,
    ...
    # --- Engine (PW1200G) ---
    "engine_name": "PW1200G",
    "tsfc_cruise": 0.50,               # lb/(lb-hr), Raymer Table 3.3
